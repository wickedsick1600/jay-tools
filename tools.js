...
const TOOLS = [
  ...
  },
  {
    ...
    hint: 'Convert and compress images',
    description: 'Convert JPEG, PNG, WebP, AVIF, BMP, or GIF files to WebP, JPEG, or PNG and compare the real file sizes.',
    longDescription: 'Convert one image or a batch to browser-friendly WebP, JPEG, or PNG. Optionally limit dimensions, preserve aspect ratio, compare actual before-and-after sizes, and download individual files or a ZIP. Processing stays in your browser.',
    category: 'image',
    group: 'image',
    icon: 'convert-image',
    featured: true,
    browserOnly: true,
    tags: ['image', 'convert', 'converter', 'compress', 'compression', 'webp', 'jpeg', 'jpg', 'png', 'avif', 'bmp', 'gif', 'batch', 'zip'],
    url: './image-converter/',
    status: 'live',
  },
  {
  ...
  },
  {
    ...
    hint: 'Count words and reading time',
    description: 'Count words, visible characters, sentences, paragraphs, lines, and estimated reading or speaking time.',
    longDescription: 'Paste or type any text and see language-aware word, character, sentence, paragraph, and line counts update instantly. Includes reading and speaking time estimates, with no upload or saved history.',
    category: 'text',
    group: 'text',
    icon: 'count',
    browserOnly: true,
    tags: ['word', 'counter', 'character', 'sentence', 'paragraph', 'line', 'reading time', 'speaking time', 'writing'],
    url: './word-counter/',
    status: 'live',
  },
  {
  ...
  },
  {
    ...
    longDescription: 'Drop in a topic, a block of notes, or a text file, pick how many questions you want, and get a practice quiz with answers.',
    category: 'ai',
    group: 'ai',
    icon: 'exam',
  ...
  },
  {
    ...
    longDescription: 'Format, minify, and validate JSON, then fold or expand nested objects and arrays in a code-editor-style result. Exact syntax error locations, pure browser, nothing uploaded.',
    category: 'dev',
    group: 'code',
    icon: 'json',
    featured: false,
    browserOnly: true,
    tags: ['json', 'format', 'beautify', 'minify', 'validate', 'lint', 'fold', 'collapse', 'expand', 'code editor'],
    url: './json-formatter/',
    status: 'live',
  },
  {
  ...
  },
  {
    ...
    hint: 'Convert to several currencies',
    description: 'Convert one amount into multiple currencies at once using recent daily reference exchange rates.',
    longDescription: 'Choose a source currency and add multiple targets such as PHP, USD, and AED. Rates come from the no-key Frankfurter service, are cached for offline fallback, and never include your amount in the network request.',
    category: 'finance',
    group: 'finance',
    icon: 'currency',
    featured: true,
    tags: ['currency', 'exchange', 'converter', 'rate', 'money', 'usd', 'php', 'aed', 'eur', 'finance'],
...
function iconMarkup(icon) {
  const icons = {
    ...
    'convert-image': '<svg aria-hidden="true" focusable="false" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="13" height="11" rx="2"/><path d="m6 13 3-3 4 4"/><path d="M17 9h4l-2-2"/><path d="M21 9l-2 2"/><path d="M7 18h10l-2 2"/><path d="m7 18 2-2"/></svg>',
    count: '<svg aria-hidden="true" focusable="false" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h10"/><path d="M4 12h8"/><path d="M4 18h6"/><path d="M17 5v14"/><path d="M14 8h6"/><path d="M14 16h6"/></svg>',
    currency: '<svg aria-hidden="true" focusable="false" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8"/><path d="M15 8.5h-4a2 2 0 0 0 0 4h2a2 2 0 0 1 0 4H9"/><path d="M12 6.5v2"/><path d="M12 16.5v2"/></svg>',
